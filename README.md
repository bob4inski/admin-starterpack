...
0. Собрать свой дебиановский пакет с приложением на python3 которое позволит запускать

1. Использование SSL в nginx
...
3. Системы управления конфигурациями part 2
...
4. K8s - тут я честно дам копипасту, которую делал раньше сам
Полезная лекция:
